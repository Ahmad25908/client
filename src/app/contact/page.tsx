  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        console.error('Contact form error:', result.error); // Log for debugging
        setSubmitStatus({
          type: 'error',
          message: result.error || 'Failed to send message. Please check your connection and try again.'
        });
      }
    } catch (error) {
      console.error('Submission error:', error); // Debug logging
                  ...
                  <div className="space-y-6">
                    <div>
                      ...
                      <input
                        ...
                        required
                        className="w-full bg-[#020617] border border-white/10 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all"
